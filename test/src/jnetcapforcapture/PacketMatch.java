...
//			ip.
			ipsum++;
//			tcpsum++;
//			System.out.println("输出ip的总数"+tcpsum);
			handleIp(packet);
			System.out.println("总的ip的数量"+ipsum);
	...
	public void handlePacketHttp(JPacket packet) {

		if (packet.hasHeader(tcp)) {
			tcpsum++;
//			System.out.println("输出tcp的大小"+tcpsum);
		}
		if (packet.hasHeader(http)) {
			httpsum++;
//			System.out.println("httpsum:         "+httpsum);
			handleHttp(packet);
		}

	}

//	public static void getPacketHttp(List<JPacket> jPackets) {// 根据包头选择不同的规则
//
//		List<JPacket> sJPackets = new ArrayList<JPacket>();
//		sJPackets = jPackets;
//		for (JPacket jPacket : sJPackets) {
//
...
//
//		}
//		System.out.println("http:     " + httpsum);
//	}
...
//				
//				httprequestconut++;
//				System.out.println("htttp ra "+httprequestconut);
...
//		}
	...
	private static void handleHttp(JPacket packet) {
